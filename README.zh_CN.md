...
| attrs   | `Record<string, string \| boolean> \| ((href: string) => Record<string, string \| boolean>)` | `{ crossorigin: true }`   | [link标签属性](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/link#attributes) |
